...
const BoardAdvisior = () => {
  ...
  <div className="full-row" style={{marginTop: 50}}>
    <div className="container">
      <div className="row">
        <div className="col">
          <h3 className="text-secondary mt-5">Our Board Advisors</h3>
        </div>
      </div>
    </div>
  </div>
                ...
                <div className="entry-content-wrapper">
                  <div className="entry-header d-flex pb-2">
                    <div className="me-auto">
                      ...
                      <span className="font-fifteen">DIRECTOR CS HOUSING &amp; DEVELOPERS LTD</span>
                    </div>
                  </div>
                </div>
              </div>
