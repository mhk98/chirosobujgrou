      ...
      <div className="row align-items-center">
        <div className="col-md-8">
          <div className="me-auto">
            ...
            <span className="d-table sub-title text-secondary">Mauris primis turpis Laoreet magna felis mi amet quam enim
              curae. Sodales semper tempor dictum.</span>
          </div>
        </div>
        <div className="col-md-4">
          <a href="#" className="ms-auto btn-link d-table py-3 md-mx-0">View All Properties</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div className="row row-cols-xxl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 g-4">
        <div className="col">
          <div className="property-grid-7 property-block bg-white transation-this">
            ...
            <div className="property_text">
              <span className="listing-price">$1850<small> ( Monthly )</small></span>
              <h5 className="listing-title">
                <a href="property-single-v1.html">Family House Residense</a>
              </h5>
              <span className="listing-location"><i className="fas fa-map-marker-alt" /> 4213 South
                Burlington, VT 05403</span>
              <ul className="d-flex quantity font-fifteen">
                <li title="Beds">
                  <span><i className="fa-solid fa-bed" /></span>7
                </li>
                <li title="Baths">
                  <span><i className="fa-solid fa-shower" /></span>5
                </li>
                <li title="Area">
                  <span><i className="fa-solid fa-vector-square" /></span>1200
                  Sqft
                </li>
                <li title="Gas">
        ...
        <div className="col">
          <div className="property-grid-7 property-block bg-white transation-this">
            ...
            <div className="property_text">
              <span className="listing-price">$1221850<small> ( Only )</small></span>
              <h5 className="listing-title">
        ...
        <div className="col">
          <div className="property-grid-7 property-block bg-white transation-this">
            ...
            <div className="property_text">
              <span className="listing-price">$1801250<small> ( Only )</small></span>
              <h5 className="listing-title">
                <a href="property-single-v1.html">Florida Sea View Appartment</a>
              </h5>
              <span className="listing-location"><i className="fas fa-map-marker-alt" /> 4213 South
                Burlington, VT 05403</span>
              <ul className="d-flex quantity font-fifteen">
        ...
        <div className="col">
          <div className="property-grid-7 property-block bg-white transation-this">
            ...
            <div className="property_text">
              <span className="listing-price">$11250<small> ( Monthly )</small></span>
              <h5 className="listing-title">
                <a href="property-single-v1.html">New Yourk City Appartment</a>
              </h5>
              <span className="listing-location"><i className="fas fa-map-marker-alt" /> 4213 South
                Burlington, VT 05403</span>
              <ul className="d-flex quantity font-fifteen">
