...
const PromotionalPrinting = () => {
    return (
        <div>
        {/*============== Page Banner Start ==============*/}
        <div className="page-banner-simple bg-secondary py-50" style={{backgroundImage: 'url(assets/images/background/bg-1.png)', backgroundRepeat: 'no-repeat', backgroundPosition: 'center center', backgroundSize: 'cover', marginTop: 100}}>
          <div className="container">
            <div className="row">
              <div className="col-lg-6">
                <h3 className="banner-title text-white">Land Wanted</h3>
                <span className="banner-tagline font-medium text-white">We make strategies, design &amp; development to create valuable
                  products.</span>
              </div>
            </div>
          </div>
...
export default PromotionalPrinting;